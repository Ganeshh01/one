  ...
  <style>
    ...
    * {
    ...
    .btn-dark:hover {
      ...
      box-shadow: 0 12px 24px #10111422;
    }
    .btn-lime {
      background: var(--lime);
      color: var(--ink);
    ...
    .btn-lime:hover {
      transform: translateY(-3px);
      box-shadow: 0 12px 24px #c8ff3d55;
    }
    .btn-light {
      background: #fff;
    ...
    header {
      ...
      border-bottom: 1px solid #1011140d;
      animation: fadeInDown .5s var(--ease);
    }
    ...
    .hero-shell {
      ...
      position: relative;
      animation: heroFade .8s var(--ease);
    }
    @keyframes heroFade {
    ...
    .hero-image:after {
      ...
      position: absolute;
      inset: 0;
      background: linear-gradient(90deg, var(--ink) 0%, transparent 38%);
    }
    .hero-float {
      position: absolute;
      z-index: 3;
      ...
      border-radius: 18px;
      max-width: 190px;
      animation: floatIn .8s .6s var(--ease-bounce) both;
    ...
    .cat-card:hover {
      ...
      box-shadow: 0 16px 32px #10111422;
    }
    .cat-card .icon-wrap {
      width: 52px;
      height: 52px;
    ...
    .product-card .badge {
      ...
      font-weight: 800;
      text-transform: uppercase;
      animation: badgePop .4s .3s var(--ease-bounce) both;
    }
    @keyframes badgePop {
    ...
    .testimonial-card:nth-child(3) { animation-delay: .25s; }
    .testimonial-card:nth-child(4) { animation-delay: .35s; }
